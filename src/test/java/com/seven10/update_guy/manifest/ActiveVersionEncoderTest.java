...
public class ActiveVersionEncoderTest
{
	 ...
	 * and {@link com.seven10.update_guy.manifest.ActiveVersionEncoder#writeVersionEntry(java.nio.file.Path, com.seven10.update_guy.manifest.ManifestEntry)}.
	 * @throws IOException 
	 */
	@Test
	...
	/**
	 * Test method for {@link com.seven10.update_guy.manifest.ActiveVersionEncoder#writeVersionEntry(java.nio.file.Path, com.seven10.update_guy.manifest.ManifestEntry)}.
	 * @throws IOException 
	 */
	@Test(expected=IllegalArgumentException.class)
